...
>
> Q-01 ～ Q-11 均已於 PRD v3.5／v3.7 裁定，紀錄留在 [cross-check-v3.md](cross-check-v3.md) §6。

---

## Q-12 🟠 `max_tokens` 2048 與「12 筆地點」的最壞情況不相容
...
## Q-13 🟡 `reason: "not_configured"` 未列於 PRD §7.1 的錯誤碼清單
